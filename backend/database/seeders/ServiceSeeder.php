    ...
    public function run()
    {
        ...
        DB::table('services')->insert([
            [
                ...
                'image' => url('public/img/service/webApp.png'),
            ...
            [
                ...
                'image' => url('public/img/service/mobileApp.png'),
                'created_at' => Carbon::now(),
                'updated_at' => Carbon::now(),
            ],
            [
                ...
                'image' => url('public/img/service/system.png'),
                'created_at' => Carbon::now(),
                'updated_at' => Carbon::now(),
            ],
            [
            ...
            [
                ...
                'image' => url('public/img/service/biSolution.png'),
                'created_at' => Carbon::now(),
                'updated_at' => Carbon::now(),
            ],
        ]);
